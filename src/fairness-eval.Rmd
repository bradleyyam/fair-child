...
calculate_results <- function(model, model_yhat_fn) {
  ...
  results <- matrix(nrow = length(race_eth_all), ncol = 4)
  rownames(results) <- race_eth_all
  colnames(results) <- c('TPR', 'AUC', 'TPR10', 'Accuracy')
...
calculate_results(model = lr_early, model_yhat_fn = calculate_yhat_sklearn)
```
...
calculate_results(model = gb_early, model_yhat_fn = calculate_yhat_sklearn)
```
...
calculate_results(relu_early, calculate_yhat_NN)
```
...
calculate_results(selu_early, calculate_yhat_NN)
```
...
calculate_results(model = lr_late, model_yhat_fn = calculate_yhat_sklearn)
```
...
calculate_results(model = gb_late, model_yhat_fn = calculate_yhat_sklearn)
```
...
calculate_results(relu_late, calculate_yhat_NN)
```
...
calculate_results(model = lr_preterm, model_yhat_fn = calculate_yhat_sklearn)
```
...
calculate_results(model = gb_preterm, model_yhat_fn = calculate_yhat_sklearn)
```
...
calculate_results(relu_preterm, calculate_yhat_NN)
```
...
calculate_results(selu_preterm, calculate_yhat_NN)
```
