...
write.csv(pregs_train_select, "data/sim/pregsim_train.csv", row.names = FALSE)
write.csv(pregs_val_select, "data/sim/pregsim_val.csv", row.names = FALSE)
write.csv(pregs_test_select, "data/sim/pregsim_test.csv", row.names = FALSE)
```
